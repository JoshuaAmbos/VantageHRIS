    ...
    <div
        ...
        <div class="p-4 sm:p-8">
            <form action="{{ route('departments.store') }}" method="POST" class="space-y-6">
                ...
                {{-- FIXED: Pass natural default active state constraint to pass FormRequest verification parameters
                --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <select name="manager_id" id="manager_id"
                            ...
                            @foreach($employees as $employee)
                                {{-- FIXED: Property value corrected to map first_name correctly --}}
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full px-4 py-2.5 bg-white border border-[#e2e8f0] text-base text-[#081a2b] rounded-xl focus:outline-none focus:border-[#2982d6] focus:ring-1 focus:ring-[#2982d6] transition-all shadow-xs">{{ old('description') }}</textarea>
