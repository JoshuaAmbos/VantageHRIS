<x-app-layout>
    ...
    <div
        ...
        <div class="px-6 py-5 sm:px-8 sm:py-6 border-b border-[#e2e8f0] bg-[#f8fafc]">
            ...
            <p class="text-sm sm:text-base text-[#2168ab] mt-1">Please fill out the details below to add a new member to
                the organization.</p>
        </div>
        ...
        <div class="p-4 sm:p-8">
            <form action="{{ route('employees.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    {{-- 1. Names --}}
                    <div>
                        <label for="first_name" class="block text-base font-bold text-[#081a2b] mb-1.5">First Name <span
                    ...
                    <div>
                        <label for="last_name" class="block text-base font-bold text-[#081a2b] mb-1.5">Last Name <span
                                class="text-rose-500">*</span></label>
                    ...
                    {{-- 2. Contact Info --}}
                    <div>
                        <label for="email" class="block text-base font-bold text-[#081a2b] mb-1.5">Email Address <span
                                class="text-rose-500">*</span></label>
                    ...
                    <div>
                        <label for="phone" class="block text-base font-bold text-[#081a2b] mb-1.5">Phone Number <span
                                class="text-rose-500">*</span></label>
                    ...
                    <div class="md:col-span-2">
                        <label for="address" class="block text-base font-bold text-[#081a2b] mb-1.5">Residential Address
                    ...
                    <div class="md:col-span-2 pt-4 border-t border-[#e2e8f0]">
                        <h4 class="text-xs font-bold text-[#2168ab] uppercase tracking-widest mb-4">Employment Details
                        </h4>
                    </div>
                    ...
                    <div>
                        <label for="position" class="block text-base font-bold text-[#081a2b] mb-1.5">Position <span
                                class="text-rose-500">*</span></label>
                    ...
                    <div>
                        <label for="employment_status" class="block text-base font-bold text-[#081a2b] mb-1.5">Status
                            <span class="text-rose-500">*</span></label>
                    ...
                    <div>
                        <label for="hire_date" class="block text-base font-bold text-[#081a2b] mb-1.5">Hire Date <span
                                class="text-rose-500">*</span></label>
