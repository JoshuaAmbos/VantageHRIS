    ...
    <div class="max-w-4xl mx-auto mt-6 px-2 sm:px-0">
        <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-[#e2e8f0] p-4 sm:p-8">
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[#2168ab] text-sm sm:text-base font-medium mt-1">
                            {{ $employee->position }} <span class="mx-1 text-[#a9cdef]">•</span>
                ...
                @else
                    <span
                        class="px-4 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase bg-indigo-50 text-indigo-700 border border-indigo-100 self-start sm:self-center">
                        {{ $employee->employment_status }}
                    </span>
                @endif
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                <div class="space-y-5">
                    ...
                    <div>
                        <p class="text-xs text-[#7eb4e7] uppercase tracking-wider font-bold mb-1">Residential Address
                        </p>
