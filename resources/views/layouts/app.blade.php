...
<body x-data="{ mobileMenuOpen: false }"
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition-opacity ease-linear duration-300"
        ...
        class="fixed inset-0 bg-[#06121e]/60 z-30 lg:hidden" style="display: none;"></div>

    <aside :class="mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        class="w-64 bg-white flex-shrink-0 flex flex-col lg:static transform transition-transform duration-300 ease-in-out">
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-[#f8fafc] ml-0">

        <header class="h-16 bg-white flex items-center px-4 sm:px-8 justify-between relative z-20">
            ...
            <div class="flex items-center space-x-3 sm:space-x-5 ml-auto">
                ...
                <button
                    class="p-2 text-[#549bde] hover:text-[#2168ab] hover:bg-[#eaf3fb] rounded-full transition-colors focus:outline-none relative">
                    <span
                        class="absolute top-1.5 right-1.5 w-2 h-2 bg-rose-500 rounded-full border border-white"></span>
